...
const HorizontalCardsSlider = ({title, Data,isLive}) => {
  ...
  return (
    <div id='HorizontalCardsSlider' className='HorizontalCardsSlider-wrapper' >
        ...
        <div id="toLeft" className="HorizontalCardsSlider-btn" onClick={()=>scrollIt(false)}><i className="fa">&#xf053;</i></div>
        <div id="toRight" className="HorizontalCardsSlider-btn" onClick={()=>scrollIt(true)}><i className="fa">&#xf054;</i></div>
